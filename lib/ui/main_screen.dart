...
class _MainScreenState extends State<MainScreen> {
  ...
  // TODO: Add index key
  static const String prefSelectedIndexKe = 'selectedIndex';
  ...
  void savedCurrentIndex() async {
    final prefs = await SharedPreferences.getInstance();
    prefs.setInt(prefSelectedIndexKe, _selectedIndex);
  }
  ...
  void getCurrentIndex() async {
    final prefs = await SharedPreferences.getInstance();
    if(prefs.containsKey(prefSelectedIndexKe)) {
      setState(() {
        final index = prefs.getInt(prefSelectedIndexKe);
        if(index != null) {
          _selectedIndex = index;
        }
      });
